...
export default function SignInPage() {
  return (
    <div className="min-h-screen relative overflow-hidden bg-zinc-50 dark:bg-zinc-950 flex items-center justify-center px-4">
      ...
      {/* Ambient glow orbs */}
      <div className="absolute -top-40 -left-40 w-96 h-96 bg-purple-600 rounded-full blur-3xl opacity-20 pointer-events-none" />
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-amber-500 rounded-full blur-3xl opacity-15 pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 w-full max-w-md">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-bold text-zinc-900 dark:text-white text-lg tracking-tight">Aevaia</span>
        </div>
