...
export const metadata: Metadata = {
  title: "Privacy Policy — Aevaia",
  description: "How Aevaia collects, uses, and protects your personal data.",
};
    ...
    <main className="min-h-screen bg-zinc-50 dark:bg-neutral-950 text-zinc-900 dark:text-white">
      ...
      <article className="max-w-3xl mx-auto px-6 py-16 prose prose-invert prose-sm prose-neutral">
        ...
        <p className="text-zinc-500 dark:text-neutral-500 not-prose mb-10 text-sm">
          Aevaia (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) is committed to protecting your personal information. This policy
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <ul className="space-y-2 text-sm text-neutral-400 list-disc list-inside leading-relaxed">
              ...
              <li><strong className="text-neutral-200">Payment data</strong> — processed entirely by Stripe. We store only a Stripe Customer ID reference; no card numbers are held by Aevaia.</li>
          ...
          <section>
            ...
            <p className="text-sm text-neutral-400 leading-relaxed mb-3">
              Aevaia uses <strong className="text-neutral-200">Clerk</strong> for authentication. Clerk sets httpOnly, Secure session cookies to maintain your login state; these are managed automatically and expire with your session.
            </p>
